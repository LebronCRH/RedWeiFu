module.exports =(function(window, document) {
	...
	var dateopts={
			...
			var Mdate=function(el,opts){
				...
				this.id=el;this.selectorId=d.getElementById(this.id);
			...
			Mdate.prototype={
				...
				dateBoxShow:function(){
					var that=this;that.selectorId.onclick=function(){
						that.createDateBox();
						that.dateSure()
					}
				},
				createDateBox:function(){
					var that=this;MdatePlugin=d.getElementById("MdatePlugin");
					if(!MdatePlugin){
						dateContentBox=d.createElement("div");
						dateContentBox.id="MdatePlugin";
						d.body.appendChild(dateContentBox);
						MdatePlugin=d.getElementById("MdatePlugin")}MdatePlugin.setAttribute("class","slideIn");
						that.createDateUi();
				...
				createDateYMD:function(type){
					...
					if(type=="year"){
						beginNum=that.beginYear;endNum=that.endYear
					}
					if(type=="month"){
						unitName="月";dataStyle="data-month";beginNum=that.beginMonth;endNum=12;
					...
					if(type=="day"){
						unitName="日";dataStyle="data-day";beginNum=1;endNum=new Date(yearTag,monthTag,0).getDate();
				...
				initScroll:function(){
					...
					yearScroll=new iScroll("yearwrapper",{
						...
						onScrollEnd:function(){
							...
							monthUl.innerHTML=that.createDateYMD("month");monthScroll.refresh();
							try{
				...
				refreshScroll:function(){
						...
						dateSure:function(){
							var that=this;var sureBtn=d.getElementById("dateSure");
